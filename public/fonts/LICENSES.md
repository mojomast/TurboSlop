...
| restrained | Inter | `inter-latin-var.woff2` | `'wght' 100 900` | https://fonts.google.com/specimen/Inter | [OFL-1.1](https://raw.githubusercontent.com/google/fonts/main/ofl/inter/OFL.txt) |
...
## Source Serif 4 — literary

- Direction: literary
- CSS family: `Source Serif 4`
- Files: `source-serif-4-latin-var.woff2` (latin subset, variable 'opsz' 8 60, 'wght' 200 900, unmodified)
- Weight range: 200–900
- Upstream source: <https://fonts.google.com/specimen/Source+Serif+4>
- Repository licence: <https://raw.githubusercontent.com/google/fonts/main/ofl/sourceserif4/OFL.txt>
- Licence: SIL Open Font License 1.1 (SPDX: `OFL-1.1`)
- Purpose: Optical-size serif for editorial reading and literary drop caps.
...
- Direction: friendly
- CSS family: `Nunito`
- Files: `nunito-latin-var.woff2` (latin subset, variable 'wght' 200 1000, unmodified)
- Weight range: 200–1000
- Upstream source: <https://fonts.google.com/specimen/Nunito>
- Repository licence: <https://raw.githubusercontent.com/google/fonts/main/ofl/nunito/OFL.txt>
- Licence: SIL Open Font License 1.1 (SPDX: `OFL-1.1`)
- Purpose: Rounded humanist sans — soft, toy-like, approachable.
...
- Direction: technical
- CSS family: `JetBrains Mono`
- Files: `jetbrains-mono-latin-var.woff2` (latin subset, variable 'wght' 100 800, unmodified)
- Weight range: 100–800
- Upstream source: <https://fonts.google.com/specimen/JetBrains+Mono>
- Repository licence: <https://raw.githubusercontent.com/google/fonts/main/ofl/jetbrainsmono/OFL.txt>
- Licence: SIL Open Font License 1.1 (SPDX: `OFL-1.1`)
- Purpose: Monospace for annotations, labels and control-panel body text.
...
- CSS family: `Inter`
- Files: `inter-latin-var.woff2` (latin subset, variable 'wght' 100 900, unmodified)
- Weight range: 100–900
- Upstream source: <https://fonts.google.com/specimen/Inter>
- Repository licence: <https://raw.githubusercontent.com/google/fonts/main/ofl/inter/OFL.txt>
- Licence: SIL Open Font License 1.1 (SPDX: `OFL-1.1`)
- Purpose: Neutral low-contrast sans — quiet, legible, invisible when it should be.
